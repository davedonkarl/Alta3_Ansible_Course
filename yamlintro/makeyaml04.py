...
def main():
    ...
    yammyfile = open("/home/student/Alta3_Ansible_Course/yamlintro/myYAML.yml", "r")
    ...
    yammyfile2 = open("/home/student/Alta3_Ansible_Course/yamlintro/myYAML.yml.updated", "w")
